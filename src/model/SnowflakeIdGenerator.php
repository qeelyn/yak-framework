...
class SnowflakeIdGenerator extends Object implements IdGeneratorInterface  
{
    ...
    public function getMaxTimestamp()
    {
        if (is_null($this->_maxTimestamp)) {
            ...
            $this->_maxTimestamp = ((1 << $bits) + $this->epoch);
        }
    ...
    public function nextId()
    {
        ...
        //ID偏移组合生成最终的ID，并返回ID
        return (($this->_lastTimestamp - $this->epoch) << $this->getTimestampLeftShift()) |
            ($this->dataCenterId << $this->getDataCenterIdShift()) |
